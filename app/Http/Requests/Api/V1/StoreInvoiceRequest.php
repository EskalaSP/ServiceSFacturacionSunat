...
class StoreInvoiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Cliente — Cat 06 doc identidad, longitudes según Formato 1.3.4
            ...
            // Montos calculados (opcionales, se recalculan en DocumentCalculationService)
            ...
            // Items — longitudes según Formato 1.3.4 (descripcion max 500, valor unitario 12,10)
            ...
            // Detracción — campos validados según Formato 1.3.4 Adicionales de Cabecera
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $v) {
            ...
            // Factura: si tipo_doc es 6 (RUC), num_doc debe empezar con 10, 15, 17 o 20
            if ($tipoDoc === '6' && strlen($numDoc) === 11 && ! preg_match('/^(10|15|17|20)/', $numDoc)) {
                $v->errors()->add('cliente.num_doc', 'El RUC no tiene un prefijo válido (10, 15, 17, 20).');
            }
        });
    }
