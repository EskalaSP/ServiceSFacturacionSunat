...
import type { SharedData, SunatStatus } from '@/types';
            ...
            <div className="mx-auto flex w-full max-w-6xl flex-col gap-6">
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <KpiCard
                        ...
                        value={kpis.aceptados_mes.toString()}
                        subvalue={`${kpis.rechazados_mes} rechazados`}
                        icon={CheckCircle2}
                        iconColor="#00BA5D"
                    />
                    <KpiCard
                        label="Clientes"
                        value={kpis.clientes_total.toString()}
                        subvalue={`${kpis.pendientes_mes} en proceso`}
                        icon={Users}
                        iconColor="#F0990A"
                    />
                </div>
                ...
                <div className="grid gap-4 lg:grid-cols-3">
                    <div className="lg:col-span-2">
                        <ChartCard
                            ...
                            subtitle="Últimos 6 meses · comprobantes aceptados"
                        >
                    ...
                    <ChartCard
                        title="Estado SUNAT"
                        subtitle="Comprobantes de este mes"
                    >
                            ...
                            <ResponsiveContainer width="100%" height={220}>
                                <PieChart>
                                    <Pie
                                        ...
                                        innerRadius={45}
                                    >
                                        {estado_sunat.map((d, i) => (
                                            <Cell
                                                key={i}
                                                fill={
                                                    COLOR_ESTADO[d.estado] ??
                            ...
                            {ultimos.map((d, i) => (
                                ...
                                >
                                    ...
                                    <span className="shrink-0">
                                        <StatusBadge
                                            status={d.estado as SunatStatus}
                                        />
                                    </span>
                                </li>
                            ))}
