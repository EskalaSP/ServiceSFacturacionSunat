      ...
      + '<div style="max-width: 42rem;">'
        ...
        + '<div class="card" style="display: flex; flex-direction: column; gap: 1rem;">'
          + '<div>'
            ...
            + '<input id="s-base-url" class="input" value="' + App.escapeHtml(this.config.base_url) + '" placeholder="http://localhost:8000/api/v1" />'
            + '<p class="text-xs" style="color: rgb(100 116 139); margin-top: 0.25rem;">Ejemplo: http://localhost:8000/api/v1 o https://tu-dominio.com/api/v1</p>'
          + '</div>'
          + '<div>'
